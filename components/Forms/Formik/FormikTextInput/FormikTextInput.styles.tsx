...
export const Input = styled.input<InputProps>`
  ...
  outline: 0;
  border: 0;
  border-bottom: 3px solid ${({ theme }) => theme.colors.primary.accent};
  border-color: ${({ theme, hasError }) =>
    hasError ? theme.colors.red.lightDanger : theme.colors.primary.accent};

  &:focus-visible {
    outline: none;
    box-shadow: 0 0 0 1px ${({ theme }) => theme.colors.primary.accent};
